...
from redpajama.artifacts.downloaders import (
    WikipediaDownloader,
    OpenWebTextDownloader,
    BooksDownloader,
    CCNetDownloader,
)
from redpajama.artifacts.hash_dist import HashDist
from redpajama.artifacts.ft_trainer import FastTextTrainer
...
def parse_arguments():
    ...
    parser.add_argument(
        "--cc_input", type=str, default=None, help="cc_net output listings"
    )
    parser.add_argument(
        "--cc_input_base_uri",
        type=str,
    ...
    parser.add_argument(
        "--max_workers", type=int, default=None, help="Maximum number of workers to use"
    )
    parser.add_argument(
        "--dsir_num_samples",
        type=int,
    ...
    # sampling
    parser.add_argument(
        "--max_samples_per_book",
        type=int,
        default=None,
        help="Maximum number of samples to use per book",
    )
    parser.add_argument(
        "--max_paragraphs_per_book_sample",
        type=int,
        default=None,
...
def main(
    artifacts_dir: str,
    cc_input: str,
    cc_input_base_uri: str,
    cache_dir: str,
    overwrite: bool,
    lang: str,
    max_workers: int,
    endpoint_url: str,
    dsir_num_samples: int,
    dsir_feature_dim: int,
    classifiers_num_samples: int,
    ...
    ccnet = CCNetDownloader(
        ...
        cc_input=cc_input,
        cc_input_base_uri=cc_input_base_uri,
    ...
    if lang == "en":
        ...
        target_name = "palm"
        target_data = [wikipedia.filepath, books.filepath, openwebtext.filepath]
    else:
